    ...
    <main class="container clear"> 
      ...
      <div class="group btmspace-30"> 
        ...
        <div class="one_quarter first"> 
          <!-- ################################################################################################ -->
          <ul class="nospace">
            <li class="btmspace-15"><a href="#"><em class="heading">JOB MANAGEMENT</em> 
		<img class="borderedbox" src="images/demo/slider/5.png" alt=""></a></li>
            <li class="btmspace-15"><a href="#"><em class="heading">COMAPNIES MANAGEMENT</em> 
		<img class="borderedbox" src="images/demo/slider/7.png" alt=""></a></li>
            <li class="btmspace-15"><a href="#"><em class="heading">STUDENT REGISTRATION</em> 
		<img class="borderedbox" src="images/demo/slider/6.jpg" alt=""></a></li>
            <li><a href="#"><em class="heading">COLLEGE MANAGEMENT</em> 
		<img class="borderedbox" src="images/demo/slider/8.png" alt=""></a></li>
          </ul>
          <!-- ################################################################################################ --> 
        </div>
        <!-- / Left Column --> 
        ...
        <div class="one_half"> 
          <!-- ################################################################################################ -->
          <h2>Placement Managements</h2>
          <ul class="nospace listing">
            <li class="clear">
              <div class="imgl borderedbox"><img src="images/demo/main1.png" alt=""></div>
              <p class="nospace btmspace-15"><a href="#">Placement Management</a></p>
            ...
            <li class="clear">
              ...
              <p class="nospace btmspace-15"><a href="#">STUDENT MANAGEMENT SYSTMEM</a></p>
            ...
            <li class="clear">
              ...
              <p class="nospace btmspace-15"><a href="#">JOB MANAGEMENT SYSTEM</a></p>
